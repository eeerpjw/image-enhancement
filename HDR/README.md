...
- Deep Snapshot HDR Imaging Using Multi-Exposure Color Filter Array (ACVV 2020)
  - [[Project page (Without code)]](http://www.ok.sc.e.titech.ac.jp/res/DSHDR/)
  - [[Paper]](http://www.ok.sc.e.titech.ac.jp/res/DSHDR/data/ACCV2020.Paper)
...
- [**DeepOpticsHDR**]Deep Optics for Single-Shot High-Dynamic-Range Imaging (CVPR2020)
  - [[TensorFlow code]](https://github.com/computational-imaging/DeepOpticsHDR)
  - [[Paper]](https://openaccess.thecvf.com/content_CVPR_2020/papers/Metzler_Deep_Optics_for_Single-Shot_High-Dynamic-Range_Imaging_CVPR_2020_paper.pdf)

- Learning Rank-1 Diffractive Optics for Single-Shot High Dynamic Range Imaging (CVPR2020)
  - [[Project]](https://www.cs.princeton.edu/~fheide/SnapshotHDROptics/)
  - [[Paper]](https://openaccess.thecvf.com/content_CVPR_2020/papers/Sun_Learning_Rank-1_Diffractive_Optics_for_Single-Shot_High_Dynamic_Range_Imaging_CVPR_2020_paper.pdf)
...
- Recovering High Dynamic Range Radiance Maps from Photographs (SIGGRAPH 1997)
  - [[Project]](https://www.pauldebevec.com/Research/HDR/)
...
- [**MRF-based**] Unbounded high dynamic range photography using a modulo camera (ICCP 2015 Best Paper)
  - [[Project]](https://web.media.mit.edu/~hangzhao/modulo.html)
  - [[Paper]](https://web.media.mit.edu/~hangzhao/papers/moduloUHDR.pdf)
...
- Event-based High Dynamic Range Image and Very High Frame Rate Video Generation using Conditional Generative Adversarial Networks (CVPR 2019)
  - [[Paper]](https://openaccess.thecvf.com/content_CVPR_2019/papers/Wang_Event-Based_High_Dynamic_Range_Image_and_Very_High_Frame_Rate_CVPR_2019_paper.pdf)
